...
function PostDetailsPage() {
  ...
  return (
    <div className="w-full max-h-screen bg-light-background dark:bg-dark-background md:col-span-7 lg:col-span-4 overflow-y-auto hide-scrollbar pt-6 px-6 flex-1">
      {post ? (
        <Post
          name={post.userName}
          username={post.name}
